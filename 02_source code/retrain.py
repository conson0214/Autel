...
def maybe_download_and_extract(data_url):
  ...
  print('model file path is ', filepath)
...
def add_final_training_ops(class_count, final_tensor_name, bottleneck_tensor,
  ...
  with tf.name_scope('train'):
    if FLAGS.optimizer == 'GradientDescent':
        ...
        tf.logging.error("Couldn't understand Optimizer name '%s'", FLAGS.optimizer)
        raise ValueError('Unknown Optimizer', FLAGS.optimizer)
...
def create_model_info(architecture):
  ...
  if architecture == 'inception_v3':
    ...
    input_std = 128
      ...
      # no need change, just need inception-2015-12-05.tgz exsist
      data_url = 'http://download.tensorflow.org/models/image/imagenet/inception-2015-12-05.tgz'
      # pylint: enable=line-too-long
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      help="""\
      choose Optimizer for Gradient Descent
